...
void SortedType<ItemType>::MergeLists(SortedType<ItemType>& other, SortedType<ItemType>& result)
{
    ...
    //fail code
    NodeType<ItemType>* location = listData;
    NodeType<ItemType>* otherLocation = other.listData;
    NodeType<ItemType>* newNode;
    NodeType<ItemType>* resultLocation;
    NodeType<ItemType>* startLocation;

    resultLocation = new NodeType<ItemType>;
    startLocation = resultLocation;
    
    while (location != NULL && otherLocation != NULL)
    {
        newNode = new NodeType<ItemType>;
        if (location->info < otherLocation->info)
        {
        ...
        {
            newNode->info = otherLocation->info;
            otherLocation = otherLocation->next;
        }
        resultLocation->next = newNode;
        resultLocation = newNode;
    }
    ...
    result.listData = startLocation->next;
